...
export class HeaderPage extends SalesPortalPage {
  ...
  constructor(page: Page) {
    ...
    this.notificationButton = this.page.locator('#notification-bell');
    this.themeToggleButton = this.page.locator('#theme-toggle');
    this.userMenuButton = this.page.locator('#user-menu-button');
